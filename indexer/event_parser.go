...
var EventProcessors = map[common.Hash]*EventProcessor{
	...
	common.HexToHash("0x6cc19a794d6a439023150cd58748eed4353190c0bb060d2e6250e2df4a68b673"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			SELECT id, $6, $7, $8
			FROM inserted_event`,
				collectModuleWhitelisted.Raw.BlockNumber, collectModuleWhitelisted.Raw.TxHash.Hex(), collectModuleWhitelisted.Raw.TxIndex, collectModuleWhitelisted.Raw.Index, collectModuleWhitelisted.Raw.Removed, collectModuleWhitelisted.CollectModule, collectModuleWhitelisted.Whitelisted, collectModuleWhitelisted.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x0b227b550ffed48af813b32e246f787e99581ee13206ba8f9d90d63615269b3f"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
				...
				SELECT id, $6, $7, $8, $9
				FROM inserted_event`,
				collectNFTDeployed.Raw.BlockNumber, collectNFTDeployed.Raw.TxHash.Hex(), collectNFTDeployed.Raw.TxIndex, collectNFTDeployed.Raw.Index, collectNFTDeployed.Raw.Removed, collectNFTDeployed.ProfileId, collectNFTDeployed.PubId, collectNFTDeployed.CollectNFT, collectNFTDeployed.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x68edb7ec2c37d21b3b72233960b487f2966f4ac82b7430d39f24d1f8d6f99106"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
				...
				FROM inserted_event`,
				collectNFTTransferred.Raw.BlockNumber, collectNFTTransferred.Raw.TxHash.Hex(), collectNFTTransferred.Raw.TxIndex, collectNFTTransferred.Raw.Index, collectNFTTransferred.Raw.Removed, collectNFTTransferred.ProfileId, collectNFTTransferred.PubId, collectNFTTransferred.CollectNFTId, collectNFTTransferred.From, collectNFTTransferred.To, collectNFTTransferred.Timestamp)
			if err != nil {
	...
	common.HexToHash("0xed39bf0d9afa849610b901c9d7f4d00751ba20de2db023428065bec153833218"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
				...
				FROM inserted_event`,
				collected.Raw.BlockNumber, collected.Raw.TxHash.Hex(), collected.Raw.TxIndex, collected.Raw.Index, collected.Raw.Removed, collected.Collector, collected.ProfileId, collected.PubId, collected.RootProfileId, collected.RootPubId, collected.CollectModuleData, collected.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x0afd7c479e8bc7dcdb856b3cc27d2332dfe1f018fde574ea124919ddcae8a933"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
				...
				SELECT id, $6, $7, $8
				FROM inserted_event`,
				defaultProfileSet.Raw.BlockNumber, defaultProfileSet.Raw.TxHash.Hex(), defaultProfileSet.Raw.TxIndex, defaultProfileSet.Raw.Index, defaultProfileSet.Raw.Removed, defaultProfileSet.Wallet, defaultProfileSet.ProfileId, defaultProfileSet.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x22baaec4952f35f59e45bd2ddb287e1ccc6d319375770c09428eb8f8d604e065"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
				...
				dispatcherSet.Raw.BlockNumber, dispatcherSet.Raw.TxHash.Hex(), dispatcherSet.Raw.TxIndex, dispatcherSet.Raw.Index, dispatcherSet.Raw.Removed, dispatcherSet.ProfileId, dispatcherSet.Dispatcher, dispatcherSet.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x676c0801b0f400762e958ee31cfbb10870e70786f6761f57c8647e766b0db3d9"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			SELECT id, $6, $7, $8, $9 FROM inserted_event`,
				emergencyAdminSet.Raw.BlockNumber, emergencyAdminSet.Raw.TxHash.Hex(), emergencyAdminSet.Raw.TxIndex, emergencyAdminSet.Raw.Index, emergencyAdminSet.Raw.Removed, emergencyAdminSet.Caller, emergencyAdminSet.OldEmergencyAdmin, emergencyAdminSet.NewEmergencyAdmin, emergencyAdminSet.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x4e84a529f4c627b5e787037d117873af1018768804cca3c7f0d47041fe2c89ed"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
					...
					SELECT id, $6, $7
					FROM inserted_event`,
				feeModuleBaseConstructed.Raw.BlockNumber, feeModuleBaseConstructed.Raw.TxHash.Hex(), feeModuleBaseConstructed.Raw.TxIndex, feeModuleBaseConstructed.Raw.Index, feeModuleBaseConstructed.Raw.Removed, feeModuleBaseConstructed.ModuleGlobals, feeModuleBaseConstructed.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x92d95e400932d129885e627b38b169cbb28443ffaaa282d0fba0cf8797721359"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
					...
					SELECT id, $6, $7, $8, $9
					FROM inserted_event`,
				followModuleSet.Raw.BlockNumber, followModuleSet.Raw.TxHash.Hex(), followModuleSet.Raw.TxIndex, followModuleSet.Raw.Index, followModuleSet.Raw.Removed, followModuleSet.ProfileId, followModuleSet.FollowModule, followModuleSet.FollowModuleReturnData, followModuleSet.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x52c5b7889df9f12f84ec3da051e854e5876678370d8357959c23ef59dd6486df"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
				...
				SELECT id, $6, $7, $8
				FROM inserted_event`,
				followModuleWhitelisted.Raw.BlockNumber, followModuleWhitelisted.Raw.TxHash.Hex(), followModuleWhitelisted.Raw.TxIndex, followModuleWhitelisted.Raw.Index, followModuleWhitelisted.Raw.Removed, followModuleWhitelisted.FollowModule, followModuleWhitelisted.Whitelisted, followModuleWhitelisted.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x44403e38baed5e40df7f64ff8708b076c75a0dfda8380e75df5c36f11a476743"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
					...
					SELECT id, $6, $7, $8
					FROM inserted_event`,
				followNFTDeployed.Raw.BlockNumber, followNFTDeployed.Raw.TxHash.Hex(), followNFTDeployed.Raw.TxIndex, followNFTDeployed.Raw.Index, followNFTDeployed.Raw.Removed, followNFTDeployed.ProfileId, followNFTDeployed.FollowNFT, followNFTDeployed.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x40487072dc56f384287d26fbe090f404143c2737d54632177451d1f74bd82c76"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
					...
					SELECT id, $6, $7, $8, $9 FROM inserted_event`,
				followed.Raw.BlockNumber, followed.Raw.TxHash.Hex(), followed.Raw.TxIndex, followed.Raw.Index, followed.Raw.Removed, followed.Follower, followed.ProfileIds, followed.FollowModuleDatas, followed.Timestamp)
			if err != nil {
	...
	common.HexToHash("0xc67fc3972da5d6434ab7b796ba133c240d40ee4e69129963c5aa0f2a6f7c3ad6"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
					...
					SELECT id, $6, $7, $8, $9, $10 FROM inserted_event`,
				followsApproved.Raw.BlockNumber, followsApproved.Raw.TxHash.Hex(), followsApproved.Raw.TxIndex, followsApproved.Raw.Index, followsApproved.Raw.Removed, followsApproved.Owner, followsApproved.ProfileId, followsApproved.Addresses, followsApproved.Approved, followsApproved.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x5538c80c8d3bee397d87a7d153f7f085bb12adf2fe25a026c7cc4e83d8c5f1d7"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
					...
					SELECT id, $6, $7, $8, $9 FROM inserted_event`,
				followsToggled.Raw.BlockNumber, followsToggled.Raw.TxHash.Hex(), followsToggled.Raw.TxIndex, followsToggled.Raw.Index, followsToggled.Raw.Removed, followsToggled.Owner, followsToggled.ProfileIds, followsToggled.Enabled, followsToggled.Timestamp)
			if err != nil {
	...
	common.HexToHash("0xf1a1fa6b64aa95186f5a1285e76198d0da80d9c5a88062641d447f1d7c54e56c"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `
				...
				moduleBaseConstructed.Raw.BlockNumber, moduleBaseConstructed.Raw.TxHash.Hex(), moduleBaseConstructed.Raw.TxIndex, moduleBaseConstructed.Raw.Index, moduleBaseConstructed.Raw.Removed, moduleBaseConstructed.Hub, moduleBaseConstructed.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x79c3cefc851fd6040f06af202c542818d9fb39bcddcb7a7e3f563b15300a2743"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `WITH inserted_event AS ( INSERT INTO "Event" ("blockNumber", "txHash", "txIndex", "logIndex", "removed", "event" ) VALUES ($1, $2, $3, $4, $5, 'ModuleGlobalsCurrencyWhitelisted') RETURNING id ) INSERT INTO ModuleGlobalsCurrencyWhitelisted ("event_id", "currency", "prevWhitelisted", "whitelisted", "timestamp") SELECT id, $6, $7, $8, $9 FROM inserted_event`,
				moduleGlobalsCurrencyWhitelisted.Raw.BlockNumber, moduleGlobalsCurrencyWhitelisted.Raw.TxHash.Hex(), moduleGlobalsCurrencyWhitelisted.Raw.TxIndex, moduleGlobalsCurrencyWhitelisted.Raw.Index, moduleGlobalsCurrencyWhitelisted.Raw.Removed, moduleGlobalsCurrencyWhitelisted.Currency, moduleGlobalsCurrencyWhitelisted.PrevWhitelisted, moduleGlobalsCurrencyWhitelisted.Whitelisted, moduleGlobalsCurrencyWhitelisted.Timestamp)
			if err != nil {
	...
	common.HexToHash("0xbf538a2c0db3d440906b8179dd0394f68a65b0b1481da70ffee24e19dccee84c"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `WITH inserted_event AS ( INSERT INTO "Event" ("blockNumber", "txHash", "txIndex", "logIndex", "removed", "event") VALUES ($1, $2, $3, $4, $5, 'ModuleGlobalsGovernanceSet') RETURNING id) INSERT INTO ModuleGlobalsGovernanceSet ("event_id", "prevGovernance", "newGovernance", "timestamp") SELECT id, $6, $7, $8 FROM inserted_event`,
				governanceSet.Raw.BlockNumber, governanceSet.Raw.TxHash.Hex(), governanceSet.Raw.TxIndex, governanceSet.Raw.Index, governanceSet.Raw.Removed, governanceSet.PrevGovernance, governanceSet.NewGovernance, governanceSet.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x3dfc53d6b49bfbc932b215ba515f0d0ab0e17aac17726fba48075f0c16c7ffe3"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `WITH inserted_event AS ( INSERT INTO "Event" ("blockNumber", "txHash", "txIndex", "logIndex", "removed", "event" ) VALUES ($1, $2, $3, $4, $5, 'ModuleGlobalsTreasurySet') RETURNING id ) INSERT INTO ModuleGlobalsTreasurySet ("event_id", "prevTreasury", "newTreasury", "timestamp") SELECT id, $6, $7, $8 FROM inserted_event`,
				moduleGlobalsTreasurySet.Raw.BlockNumber, moduleGlobalsTreasurySet.Raw.TxHash.Hex(), moduleGlobalsTreasurySet.Raw.TxIndex, moduleGlobalsTreasurySet.Raw.Index, moduleGlobalsTreasurySet.Raw.Removed, moduleGlobalsTreasurySet.PrevTreasury, moduleGlobalsTreasurySet.NewTreasury, moduleGlobalsTreasurySet.Timestamp)
			if err != nil {
	...
	common.HexToHash("0xc672c38b4d26c3c978228e99164105280410b144af24dd3ed8e4f9d211d96a50"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `WITH inserted_event AS ( INSERT INTO "Event" ("blockNumber", "txHash", "txIndex", "logIndex", "removed", "event") VALUES ($1, $2, $3, $4, $5, 'PostCreated') RETURNING id ) INSERT INTO PostCreated ("event_id", "profileId", "pubId", "contentURI", "collectModule", "collectModuleReturnData", "referenceModule", "referenceModuleReturnData", "timestamp") SELECT id, $6, $7, $8, $9, $10, $11, $12, $13 FROM inserted_event`,
				postCreated.Raw.BlockNumber, postCreated.Raw.TxHash.Hex(), postCreated.Raw.TxIndex, postCreated.Raw.Index, postCreated.Raw.Removed, postCreated.ProfileId, postCreated.PubId, postCreated.ContentURI, postCreated.CollectModule, postCreated.CollectModuleReturnData, postCreated.ReferenceModule, postCreated.ReferenceModuleReturnData, postCreated.Timestamp)
			if err != nil {
	...
	common.HexToHash("0x4e14f57cff7910416f2ef43cf05019b5a97a313de71fec9344be11b9b88fed12"): NewEventProcessor(
		...
		func(db *pgxpool.Pool, e interface{}) error {
			...
			_, err := db.Exec(context.Background(), `WITH inserted_event AS ( INSERT INTO "Event" ("blockNumber", "txHash", "txIndex", "logIndex", "removed", "event" ) VALUES ($1, $2, $3, $4, $5, 'ProfileCreated') RETURNING id ) INSERT INTO ProfileCreated ("event_id", "profileId", "creator", "to", "handle", "imageURI", "followModule", "followModuleReturnData", "followNFTURI", "timestamp") SELECT id, $6, $7, $8, $9, $10, $11, $12, $13, $14 FROM inserted_event`,
				profileCreated.Raw.BlockNumber, profileCreated.Raw.TxHash.Hex(), profileCreated.Raw.TxIndex, profileCreated.Raw.Index, profileCreated.Raw.Removed, profileCreated.ProfileId, profileCreated.Creator, profileCreated.To, profileCreated.Handle, profileCreated.ImageURI, profileCreated.FollowModule, profileCreated.FollowModuleReturnData, profileCreated.FollowNFTURI, profileCreated.Timestamp)
			if err != nil {
